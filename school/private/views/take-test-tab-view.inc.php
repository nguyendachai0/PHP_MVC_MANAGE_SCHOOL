    ...
    <?php if ($answered_test_row) : ?>
        ...
        <?php else : ?>
            <div class="text-danger">
                This test has not yet been submitted
            </div>
            <br>
...
<?php if (isset($questions) && is_array($questions)) : ?>
    <form method="post">
        ...
        <?php if (!$submitted) : ?>
            <center>
                <small> Click save answers before moving to another page to save your answer </small><br>
                <button class="btn btn-primary">Save Your answer</button>
            </center>
        <?php endif; ?>
    </form>
...
<script>
    ...
    function submit_test(e) {
        ...
        if (percent < 100) {
            ...
            if (!confirm("You have only answered " + percent + "% of the test. Are you sill sure you want to submit")) {
                e.preventDefault();
                return;
            }
        }
