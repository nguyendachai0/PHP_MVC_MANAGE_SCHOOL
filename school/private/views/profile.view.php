            ...
            <div class="col-sm-4 col-md-3">
                ...
                <?php if (Auth::access('admin') || (Auth::access('reception') && $row->rank == 'student')) : ?>
                    ...
                    <div class="text-center">
                        <a href="<?= ROOT ?>/profile/edit/<?= $row->user_id ?>?tab=classes">
                            <button class="btn-sm btn btn-success">Edit Profile</button>
                        </a>
                        <a href="<?= ROOT ?>/profile/delete/<?= $row->user_id ?>?tab=classes">
        ...
        <div class="container-fluid">
            <ul class="nav">
                ...
                <?php if (Auth::access('lecturer') || Auth::i_own_content($row)) : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= ROOT ?>/profile/<?= $row->user_id ?>?tab=classes">Classes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= ROOT ?>/profile/<?= $row->user_id ?>?tab=tests">Tests</a>
                    </li>
                <?php endif; ?>
            </ul>
            <?php
